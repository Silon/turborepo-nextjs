 ...
 */
export const ArGlobalState = createContext<ArGlobalStateType>(
  {} as ArGlobalStateType,
);

export const ArGlobalStateActions = createContext<ArGlobalStateActionsType>(
  {} as ArGlobalStateActionsType,
);
...
export function ArGlobalStateProvider({
  ...
  return (
    <ArGlobalState.Provider value={state}>
      <ArGlobalStateActions.Provider value={actionsValue}>
        {children}
      </ArGlobalStateActions.Provider>
